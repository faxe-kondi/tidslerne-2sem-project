...
?>
        ...
        <div class="articleOverviewHeader">
            <h1 ><?php echo esc_html($categoryLabel) ?></h1>
            <p class="p2">Her finder du et bredt udvalg af artikler om <span class="lowercase"><?php echo esc_html($categoryLabel) ?></span> – fra refleksioner og praksisnære erfaringer til indsigter og idéer, der kan sætte nye tanker i gang. Brug søgefunktionen til at finde det helt rigtige til dig.</p>
